                    ...
                    {isRegistered ? (
                        ...
                        <>
                            ...
                            <footer className="mt-auto pt-6 border-t border-gray-200 flex justify-end">
                                <button onClick={validateAndProceed} className="w-full sm:w-auto px-8 py-3 bg-gray-800 text-white font-semibold rounded-md hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 transition-colors">
