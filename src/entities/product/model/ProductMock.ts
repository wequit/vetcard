...
export const mockProducts: Product[] = [
  {
    id: '1',
    name: 'Неодиар',
    description: 'Уникальный современный препарат для лечения острой хронической диареи у кошек и собак...',
  ...
  },
  {
    id: '2',
    name: 'Миртацен',
    description: 'Миртацен применяется при пищевых расстройствах у собак и кошек, связанных со снижением аппетита...',
  ...
  },
  {
    id: '3',
    name: 'Тилозин',
    description: 'Тилозин ТАБ относится к антибактериальным препаратам фармакотерапевтической группы макролиды...',
  ...
  },
  {
    id: '4',
    name: 'Maropital',
    description: 'Маропиталь - эффективное средство для лечения и предотвращения рвоты различного происхождения...',
